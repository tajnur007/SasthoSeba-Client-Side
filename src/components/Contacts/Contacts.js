...
const Contacts = () => {
    return (
        <div>
            {/* Banner Image  */}
            <div>
                <img className="img-fluid" src={bannerImage} alt="contact us banner image" />
            </div>
            ...
            <div className="container d-flex flex-wrap my-5">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div className="text-start">
                        ...
                        <div className="py-2">
                            <h4><FontAwesomeIcon icon={faMapMarkerAlt} className="text-primary" /> Address</h4>
                            343, BIDC Bazar, DUET, Gazipur, Bangladesh.
                        </div>
                        <div className="pt-2">
                            Call Us Now!
                            <h4><FontAwesomeIcon icon={faPhoneAlt} className="text-primary" /> 01721-919296</h4>
                        </div>
                        <div className="pt-2">
                            Do you have a Question?
                            <h4><FontAwesomeIcon icon={faEnvelope} className="text-primary" /> info@sasthoseba.com.bd</h4>
                        </div>
                    </div>
